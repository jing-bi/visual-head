...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        if type(images) is list or images.ndim == 5:
            # print("type(images) is list or images.ndim == 5")
            ...
            if mm_patch_merge_type == 'flat':
                # print("mm_patch_merge_type == 'flat':")
                image_features = [x.flatten(0, 1) for x in image_features]
            elif mm_patch_merge_type.startswith('spatial'):
                # 1.6 pope
                # print("mm_patch_merge_type.startswith('spatial'):")
                new_image_features = []
                for image_idx, image_feature in enumerate(image_features):
                    if image_feature.shape[0] > 1:
                        ...
                        if image_aspect_ratio == 'anyres':
                            # print("image_aspect_ratio == 'anyres':")
                            # 1.6 pope
                        ...
                        if 'unpad' in mm_patch_merge_type:
                            # print("'unpad' in mm_patch_merge_type:")
                            # 1.6 pope
            ...
            # print("NOT:type(images) is list or images.ndim == 5")
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            # print(torch.cat(cur_input_ids_noim).shape)
            ...
            for i in range(num_images + 1):
                ...
                # print(f"cur_input_embeds_no_im[{i}]",cur_input_embeds_no_im[i])
        ...
        for i, (cur_new_embed, cur_new_labels) in enumerate(zip(new_input_embeds, new_labels)):
            ...
            if getattr(self.config, 'tokenizer_padding_side', 'right') == "left":
                # print("getattr(self.config, 'tokenizer_padding_side', 'right') == 'left':")
